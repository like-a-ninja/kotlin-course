package org.example.org.example.kotlin.lessons.lesson04.homework
...
class Datatypes {
    ...
    // v6 булевые значения нельзя использовать в верхнем регистре false
    val v6: = FALSE
    val v7: Char = 'c'
    val v8: Short = 500
    ...
    // v13 булевое значение должно быть без кавычек true
    val v13 = "true"
    ...
    val v19: Float = 5.75f
    // v20 char использует одинарные кавчки и там может быть только 1 символ
    val v20 = `1.414`
    ...
    // v30 булевые значения нельзя использовать в верхнем регистре false
    val v30 = FALSE
    val v31: Double = 0.007
    // v32 char не может хранить эмодзи, нужно использовать String
    val v32 = “🤯”
    val v33: Map<String, Byte> = mapOf("true" to 2, "false" to 34)
    // v34 одинарные кавычки обозначают char, где должен быть один символ
    val v34 = ‘65535’
    ...
    // v44 булевые значения нельзя использовать в верхнем регистре false
    val v44 = TRUE
    ...
    val s12: List<String> = listOf("Ненужная тема 1", "Ненужная тема 2")
